...
XML (eXtensible Markup Language) is a language used to encode web documents and data structures. XML is also useful for transmitting information between different software systems and through APIs.

[XML](https://en.wikipedia.org/wiki/XML) was designed to be "self-descriptive" and carry data in a readable format (by humans and machines) 

> *the difference between XML and HTML is that XML is used to transport information, while HTML is used to display information.*
